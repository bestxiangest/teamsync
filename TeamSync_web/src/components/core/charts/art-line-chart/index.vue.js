...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ref: ("chartRef"), ...{ class: ("relative w-[calc(100%+10px)]") }, ...{ style: (({ height: props.height })) }, });
    ...
    __VLS_styleScopedClasses['w-[calc(100%+10px)]'];
    var __VLS_slots;

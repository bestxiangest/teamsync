...
function __VLS_template() {
    ...
    /** @type { [typeof __VLS_components.ElCol, typeof __VLS_components.ElCol, ] } */
    // @ts-ignore
    const __VLS_64 = __VLS_asFunctionalComponent(__VLS_63, new __VLS_63({ xs: ((24)), sm: ((24)), md: ((__VLS_ctx.span)), lg: ((__VLS_ctx.span)), xl: ((__VLS_ctx.span)), ...{ class: ("max-w-full flex-1") }, }));
    const __VLS_65 = __VLS_64({ xs: ((24)), sm: ((24)), md: ((__VLS_ctx.span)), lg: ((__VLS_ctx.span)), xl: ((__VLS_ctx.span)), ...{ class: ("max-w-full flex-1") }, }, ...__VLS_functionalComponentArgsRest(__VLS_64));
    ...
    if (__VLS_ctx.showSubmit) {
        ...
        /** @type { [typeof __VLS_components.ElButton, typeof __VLS_components.ElButton, ] } */
        // @ts-ignore
        const __VLS_78 = __VLS_asFunctionalComponent(__VLS_77, new __VLS_77({ ...{ 'onClick': {} }, type: ("primary"), ...{ class: ("submit-button") }, disabled: ((__VLS_ctx.disabledSubmit)), }));
        const __VLS_79 = __VLS_78({ ...{ 'onClick': {} }, type: ("primary"), ...{ class: ("submit-button") }, disabled: ((__VLS_ctx.disabledSubmit)), }, ...__VLS_functionalComponentArgsRest(__VLS_78));
        __VLS_asFunctionalDirective(__VLS_directives.vRipple)(null, { ...__VLS_directiveBindingRestFields, modifiers: {}, }, null, null);
        let __VLS_83;
        const __VLS_84 = {

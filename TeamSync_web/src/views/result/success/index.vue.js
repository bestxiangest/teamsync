...
defineOptions({ name: 'ResultSuccess' }); /* PartiallyEnd: #3632/scriptSetup.vue */
...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ type: ("success"), title: ("提交成功"), message: ("提交结果页用于反馈一系列操作任务的处理结果，如果仅是简单操作，使用 Message 全局提示反馈即可。灰色区域可以显示一些补充的信息。"), iconCode: ("ri:check-fill"), }));
    const __VLS_2 = __VLS_1({ type: ("success"), title: ("提交成功"), message: ("提交结果页用于反馈一系列操作任务的处理结果，如果仅是简单操作，使用 Message 全局提示反馈即可。灰色区域可以显示一些补充的信息。"), iconCode: ("ri:check-fill"), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};

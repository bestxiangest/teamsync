...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ type: ("fail"), title: ("提交失败"), message: ("请核对并修改以下信息后，再重新提交。"), iconCode: ("ri:close-fill"), }));
    const __VLS_2 = __VLS_1({ type: ("fail"), title: ("提交失败"), message: ("请核对并修改以下信息后，再重新提交。"), iconCode: ("ri:close-fill"), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        // @ts-ignore
        const __VLS_8 = __VLS_asFunctionalComponent(__VLS_7, new __VLS_7({ icon: ("ri:close-circle-line"), ...{ class: ("text-red-500 mr-1") }, }));
        const __VLS_9 = __VLS_8({ icon: ("ri:close-circle-line"), ...{ class: ("text-red-500 mr-1") }, }, ...__VLS_functionalComponentArgsRest(__VLS_8));
        __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
        const __VLS_13 = __VLS_resolvedLocalAndGlobalComponents.ArtSvgIcon;
        /** @type { [typeof __VLS_components.ArtSvgIcon, ] } */
        // @ts-ignore
        const __VLS_14 = __VLS_asFunctionalComponent(__VLS_13, new __VLS_13({ icon: ("ri:close-circle-line"), ...{ class: ("text-red-500 mr-1") }, }));
        const __VLS_15 = __VLS_14({ icon: ("ri:close-circle-line"), ...{ class: ("text-red-500 mr-1") }, }, ...__VLS_functionalComponentArgsRest(__VLS_14));
        __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        // @ts-ignore
        const __VLS_20 = __VLS_asFunctionalComponent(__VLS_19, new __VLS_19({ type: ("primary"), }));
        const __VLS_21 = __VLS_20({ type: ("primary"), }, ...__VLS_functionalComponentArgsRest(__VLS_20));
